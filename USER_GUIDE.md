...
3.  **Login**: Enter the admin password (default: `admin123`).
    *   *Note: For security, you will be automatically logged out after 5 minutes of inactivity.*
4.  **Attendance Logs**: See the list of people who checked in today.
5.  **User Management**: See all registered users.
6.  You can download the report as a CSV file.
...
*   **Student Profile View**:
    ...
    *   **Punctuality Score 💯**: A percentage grade (0-100%) showing discipline.
